...
def run_nuclei_inst_stat(pred_dir, true_dir, dataset, print_img_stats=False, ext=".mat"):
    ...
    file_list = glob.glob(f'{pred_dir}/*.tif')
    ...
    for filename in file_list[:]:
        ...
        pred = tif.imread(os.path.join(pred_dir, basename + ".tif"))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pred_dir", help="point to output dir", nargs="?", default="/data111/bianhao/code/zhangye/PDAM/inference/consep2tnbc", const=""
