...
def infer_fluo2tnbc(wts_root, out_pred_root, setting):
    ...
    # with testing images
    test_dataset_name = setting.split('2')[-1]
    test_root_name = f'/data111/bianhao/code/zhangye/PDAM/datasets/{test_dataset_name}/test/source_images'
